                ...
                <div className='container px-8 mx-auto mt-5 md:px-16 lg:px-24'>
                    <div className='flex flex-col items-center mb-4 md:flex-row md:space-x-12'>
                        <div className='flex-1 mb-4 md:mb-0'>
                            ...
                            <p className='tex-gray-400'>Front-End Developer based in the Nagpur, specializing in web and
                        ...
                        <div className='flex-1 w-full'>
                            <form className='flex items-center justify-center'>
                                <input type="email" placeholder='Enter Email' className='w-full p-2 bg-gray-800 border border-gray-600 rounded-l-lg focus:outline-none focus:border-green-400' />
                                <button type='submit'
                    ...
                    <div className='flex flex-col items-center justify-between pt-4 border-t border-gray-600 md:flex-row'>
                        ...
                        <div className='flex my-4 space-x-4 md:my-0'>
                            ...
                            <a href="/" className='text-gray-400 hover:text-white'>
                                <FaLinkedin />
                            </a><a href="/" className='text-gray-400 hover:text-white'>
                                <FaMedium />
                            </a><a href="/" className='text-gray-400 hover:text-white'>
                                <FaGithub />
                            </a>
